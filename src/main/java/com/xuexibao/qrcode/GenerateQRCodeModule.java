...
public class GenerateQRCodeModule {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = LoggerFactory
			.getLogger(GenerateQRCodeModule.class);
	...
	public static void encodePR(String content, int width, int height,
		...
		sb.append(".png");
		try {
			ImageIO.write(genBarcode(content, width, height, "d://1024.png"),
					"png", new File(sb.toString()));
		} catch (IOException e) {
	...
	public static void main(String[] args) {
		String content = "http://fusion.qq.com/app_download?appid=1101336554&platform=qzone&via=QZ.MOBILEDETAIL.QRCODE&u=625975068";
		encodePR(content, 2000, 2000, "1");
	}
}
