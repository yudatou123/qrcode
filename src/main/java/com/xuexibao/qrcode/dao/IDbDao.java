...
public interface IDbDao {
	 ...
	 * <li>如果实体有@id,并且插入之前给主键赋值。如果auto=true，主键还是根据数据库自增生成。如果auto=false，主键等于赋值的主键
	 * </li>
	 * <li>如果是Map的话，必须有<font color="red"><b>key=".table"(固定值)</b></font>
	 * value="tableName"(表名)。其他的key和value即为要插入的属性和值</li>
	 * </ul>
