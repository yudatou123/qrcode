...
public class ConvertUtil {
	 ...
	 * 通用的将对象转换为map的方法
	 * <p>
	 * 只将对象的原生属性转换为map的String, 如果是数组、list、map、pojo等则不处理
	 * 
	 * @param obj
	 *            待转化的对象
	 * @return map
	 ...
	 * @return map
	 */
	private static Map<String, String> obj2Map(final Object obj,
		...
		for (Field fld : flds) {
			...
			if (mr.isNumber() || mr.isBoolean() || mr.isChar()
					|| mr.isStringLike() || mr.isEnum() || mr.isDateTimeLike()) {
	 ...
	 * 通用的将对象转换为map的方法
	 * <p>
	 * 只将对象的原生属性转换为map的String, 同时支持数组、list、map、pojo等处理
	 * 
	 * @param obj
	 *            待转化的对象
	 * @return map
	 ...
	 * @return 对象
	 */
	public static <T> T map2Object(final Map<?, ?> src, final Class<T> toType) {
